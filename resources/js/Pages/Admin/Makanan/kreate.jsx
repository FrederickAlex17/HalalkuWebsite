...
export default function Create(props, errors) {
    ...
    useEffect(() => {
        const initializeBlockchain = async () => {
            const contractAddress ="0x9A9f2CCfdE556A7E9Ff0848998Aa4a0CFD8863AE"; // Replace with your contract address
                        ...
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="p-6 bg-white border-b border-gray-200">
                                ...
                                <div className="card-header">
                                    <span className="font-weight-bold">Tambah Data Makanan</span>
                                </div>
                                <div className="card-body">
                                    <form onSubmit={storeMakanan}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" value={namamakanan} onChange={(e) => setNamamakanan(e.target.value)} placeholder="Docang" />
                                        </div>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" value={jenismakanan} onChange={(e) => setJenismakanan(e.target.value)} placeholder="Nasi" />
                                        </div>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control" value={resto} onChange={(e) => setResto(e.target.value)} placeholder="Link Google Maps" />
                                        </div>
                                        {props.errors.resto && (
                                            <div className="alert alert-error">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control" value={sertifikat} onChange={(e) => setSertifikat(e.target.value)} placeholder='ID123456789'/>
                                        ...
                                        <div className="mb-3">
                                            <label className="form-label fw-bold">Nomor Sertifikat</label>
                                            <input className="form-control" value={certificate} onChange={(e) => setCertificate(e.target.value)} placeholder='ID123456789'/>
                                            <button onClick={storeCertificate}>Store Sertifikat</button>
                                        {props.errors.certificate && (
                                            <div className="alert alert-error">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                                <span>{props.errors.certificate}</span>
                                            </div>
