...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 11:25 AM
...
(1, 'Docang', 'Nasi', 'Cirebon', 12000, 'Docang adalah nasi yang disajikan dengan tauge, tahu, tempe, dan oncom. Docang biasanya disiram dengan saus kacang dan kecap manis.', '1696530877.jpg', 'Docang Pak Kumis Khas Cirebon', '2023-10-04 21:34:37', '2023-10-04 21:34:37', 'ID32110006678560723', '7HM3+WPR, Jl. Tentara Pelajar, Pekiringan, Kec. Kesambi, Kota Cirebon, Jawa Barat 45131', 'https://maps.app.goo.gl/2rnKTFMYktccx2AH7', 0),
(2, 'Nasi Jamblang', 'Nasi', 'Cirebon', 25000, 'Nasi jamblang adalah nasi yang disajikan dengan lauk-pauk yang beragam, seperti tempe, tahu, telur, dan ayam. Nasi jamblang biasanya disajikan di atas daun pisang.', '1696531243.jpg', 'Nasi Jamblang Mbak Nur', '2023-10-04 21:40:43', '2023-10-04 21:40:43', 'ID32110007860960723', 'Jl. Cangkring 2 No.34, Kejaksan, Kec. Kejaksan, Kota Cirebon, Jawa Barat 45123', 'https://maps.app.goo.gl/TuJUzzk2qAGoNf3A8', 0),
...
INSERT INTO `menudbs` (`menu_id`, `store_id`, `namamakanan`, `jenismakanan`, `stok`, `harga`, `desc`, `gambar`, `created_at`, `updated_at`) VALUES
(1, 1, 'Docang', 'Nasi', 10, 12000, 'Docang adalah nasi yang disajikan dengan tauge, tahu, tempe, dan oncom. Docang biasanya disiram dengan saus kacang dan kecap manis.', '1696530877.jpg', NULL, NULL),
(2, 2, 'Nasi Jamblang', 'Nasi', 10, 25000, 'Nasi jamblang adalah nasi yang disajikan dengan lauk-pauk yang beragam, seperti tempe, tahu, telur, dan ayam. Nasi jamblang biasanya disajikan di atas daun pisang.', '1696531243.jpg', NULL, NULL),
(3, 3, 'Nasi Lengko', 'Nasi', 10, 12000, 'Nasi lengko adalah nasi yang disajikan dengan tauge, tahu, tempe, lontong, dan kerupuk. Nasi lengko biasanya disiram dengan saus kacang dan kecap manis.', '1696531298.jpg', NULL, NULL),
(9, 3, 'Empal Gentong', 'Lauk-pauk', 10, 25000, 'Empal gentong adalah makanan berkuah yang terbuat dari daging sapi, santan, dan bumbu rempah. Empal gentong biasanya disajikan dengan nasi dan lalapan.', '1696531351.jpg', NULL, NULL),
(10, 3, 'Empal Asem', 'Lauk-pauk', 10, 25000, 'Empal asem adalah makanan berkuah yang terbuat dari daging sapi, asam jawa, dan bumbu rempah. Empal asem biasanya disajikan dengan nasi dan lalapan.', '1696531425.jpg', NULL, NULL),
(12, 4, 'Bubur Ayam Cirebon', 'Nasi', 10, 12000, 'Bubur ayam Cirebon adalah bubur ayam yang disajikan dengan suwiran ayam, irisan cakue, dan kerupuk. Bubur ayam Cirebon biasanya ditambahkan dengan kuah kaldu yang gurih.', '1696531527.jpg', NULL, NULL),
(14, 5, 'Mie Koclok', 'Mie', 10, 12000, 'Mie koclok adalah mie yang disajikan dengan kuah kaldu yang gurih dan suwiran ayam. Mie koclok biasanya ditambahkan dengan potongan kol, daun bawang, dan daun seledri.', '1696531711.jpg', NULL, NULL),
(15, 6, 'Soto Ayam Cirebon', 'Soto', 10, 12000, 'Soto ayam Cirebon adalah soto ayam yang disajikan dengan suwiran ayam, irisan tauge, dan kerupuk. Soto ayam Cirebon biasanya ditambahkan dengan kuah kaldu yang gurih.', '1696531892.jpg', NULL, NULL);
...
--
ALTER TABLE `datawisata`
  MODIFY `wisata_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
